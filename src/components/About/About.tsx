    ...
    <section className="about">
      <div className="about-inner">
        <div>
          ...
          <p className="sec-p">
            The HR profession in Nigeria is full of passionate, talented peoplemany of whom have never had a structured
            ...
            <br /><br />
            Talent Factory changes that. We built the program we wish existed when we were starting outone that takes
