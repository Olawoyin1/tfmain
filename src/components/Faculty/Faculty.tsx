...
import { FiUser, FiBriefcase, FiDollarSign, FiTarget } from 'react-icons/fi';
    ...
    <section className="faculty" id="faculty">
      ...
      <div className="faculty-main">
        ...
        <div className="faculty-content">
          <div className="faculty-role">Founder & Program Director</div>
          <div className="faculty-name">Elizabeth<br />Odetokun, PHRi</div>
          ...
          <div className="faculty-tags">
            <span className="faculty-tag">PHRi Certified</span>
            <span className="faculty-tag">MBA Candidate · Lagos Business School</span>
            <span className="faculty-tag">Data Analytics · ALX Africa</span>
            <span className="faculty-tag">B.Sc. IPM · University of Lagos</span>
            <span className="faculty-tag">6+ Years in HR Operations</span>
            <span className="faculty-tag">Startup HR Specialist</span>
          </div>
        </div>
      </div>
      ...
      <div className="faculty-promises">
        <div className="faculty-promise">
          <div className="faculty-promise-icon"><FiBriefcase size={36} /></div>
        ...
        <div className="faculty-promise">
          <div className="faculty-promise-icon"><FiDollarSign size={36} /></div>
