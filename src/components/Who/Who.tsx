...
import { FiRefreshCw, FiBookOpen, FiTrendingUp, FiCompass, FiHeart, FiStar } from 'react-icons/fi';
    ...
    <section className="who" id="who">
      ...
      <div className="who-grid">
        {whoCards.map((card, index) => (
          <div key={index} className={`who-card ${card.dark ? 'dark' : ''}`}>
            <div className="who-icon">{card.icon}</div>
            <h3 className="who-title">{card.title}</h3>
            <p className="who-desc">{card.description}</p>
